...
public class MetaDataWriter {
	...
	private static final DateTimeFormatter INSTANT_FORMATTER = DateTimeFormatter.ofPattern(PATTERN_FORMAT)
	...
	public void update(final Path path, final Instant time) {
		...
		try {
			...
			exifDirectory.add(ExifTagConstants.EXIF_TAG_DATE_TIME_ORIGINAL, INSTANT_FORMATTER.format(time));
